...
main algorithm
---------------------  
a) myNetworkSim.m: discretize the geometry of fiber network and create Abaqus input file
...
-----------------------
- createBeamMesh.m: discretize the fiber segments into equi-distant element, and define the boundary condition
...
3. After the discretization is completed, a Abaqus input file will be created. And also the initial coordinate of the boundary node set will be saved.

(Note: the Abaqus input files of the discrete fiber network is saved in "Input_fiber" for review) 
...
(Note: the postprocessing results are save in folder "Result_sim' for review)
