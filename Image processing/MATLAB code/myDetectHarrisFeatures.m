function pts = myDetectHarrisFeatures(I,varargin)
pts = myHarrisMinEigen('Harris', I, varargin{:});


function corners = myHarrisMinEigen(method, I, varargin) 
